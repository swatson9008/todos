...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n@font-face {\n  font-family: 'list-style';\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n}\n\nbody {\n  background-color: lightsteelblue;\n  display: grid;\n  grid-template-columns: 1fr 2fr 1fr;\n}\n\nbutton {\n  all: unset;\n  cursor: pointer;\n}\n\n#tabContainer {\n  display: flex;\n  justify-content: center;\n  gap: 1em;\n  margin-top: 5%;\n  grid-row: 1;\n  grid-column: 2;\n  border: 1px solid rgb(12, 12, 12);\n  margin-bottom: -.7em;\n  padding: 0.5em;\n  background-color: rgb(44, 71, 62);\n  color: azure;\n}\n\n\n#mainContainer {\n  display: flex;\n  justify-content: center;\n  margin-top: 1%;\n  border: 1px solid rgb(12, 12, 12);\n  grid-row: 2;\n  grid-column: 2;\n  padding-top: 2em;\n  padding-bottom: 2em;\n  background-color: rgb(209, 223, 223);\n  margin-bottom: 5em;\n\n}\n\n#toDoCreation, #createProjects, #toDoSection, #projectSection, #toDoWrap, #projectWrap {\n  display: none;\n}\n\n#toDoWrap {\n  min-width: inherit;\n  max-width: inherit;\n  width: 100%;\n}\n\n#toDoSection {\n  /*background-image: url(../src/img/notebook.svg);*/\n  /*background-image: url(../src/img/papertexture.jpg);*/\n  color: darkred;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));\n  grid-row: 1;\n  /*border: 1px red solid;*/\n  justify-items: center;\n  gap: 20px;\n}\n\n.ToDoListing {\n  width: 200px;\n  /*border: 1px red solid;*/\n  font-family: 'list-style' ;\n  font-size: 20px;\n}\n\n#projectWrap {\n  min-width: inherit;\n  max-width: inherit;\n  width: 100%;\n}\n\n#projectSection {\n  color: darkred;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));\n  grid-row: 1;\n  /*border: 1px red solid;*/\n  justify-items: center;\n  gap: 20px;\n}\n\n.projectLists {\n  width: 200px;\n  /*border: 1px red solid;*/\n  font-family: 'list-style' ;\n  font-size: 20px;\n}\n\n#footer {\n  display: flex;\n  align-content: center;\n  justify-content: center;\n  gap: 0.5em;\n  padding: 0.5em;\n  background-color: aliceblue;\n  grid-row: 4;\n  grid-column: 4;\n  /*border: 1px red solid;*/\n  position: fixed;\n  width: 100%;\n  bottom:0;\n  left:0;\n  right:0;\n  margin-top: 120px\n}\n\n#footertext {\n  margin-top: 0.5em;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":";AACA;EACE,yBAAyB;EACzB,4CAAgD;AAClD;;AAEA;EACE,gCAAgC;EAChC,aAAa;EACb,kCAAkC;AACpC;;AAEA;EACE,UAAU;EACV,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,QAAQ;EACR,cAAc;EACd,WAAW;EACX,cAAc;EACd,iCAAiC;EACjC,oBAAoB;EACpB,cAAc;EACd,iCAAiC;EACjC,YAAY;AACd;;;AAGA;EACE,aAAa;EACb,uBAAuB;EACvB,cAAc;EACd,iCAAiC;EACjC,WAAW;EACX,cAAc;EACd,gBAAgB;EAChB,mBAAmB;EACnB,oCAAoC;EACpC,kBAAkB;;AAEpB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,kDAAkD;EAClD,sDAAsD;EACtD,cAAc;EACd,aAAa;EACb,2DAA2D;EAC3D,WAAW;EACX,yBAAyB;EACzB,qBAAqB;EACrB,SAAS;AACX;;AAEA;EACE,YAAY;EACZ,yBAAyB;EACzB,0BAA0B;EAC1B,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,cAAc;EACd,aAAa;EACb,2DAA2D;EAC3D,WAAW;EACX,yBAAyB;EACzB,qBAAqB;EACrB,SAAS;AACX;;AAEA;EACE,YAAY;EACZ,yBAAyB;EACzB,0BAA0B;EAC1B,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,qBAAqB;EACrB,uBAAuB;EACvB,UAAU;EACV,cAAc;EACd,2BAA2B;EAC3B,WAAW;EACX,cAAc;EACd,yBAAyB;EACzB,eAAe;EACf,WAAW;EACX,QAAQ;EACR,MAAM;EACN,OAAO;EACP;AACF;;AAEA;EACE,iBAAiB;AACnB","sourcesContent":["\n@font-face {\n  font-family: 'list-style';\n  src: url('../src/asset/IndieFlower-Regular.ttf');\n}\n\nbody {\n  background-color: lightsteelblue;\n  display: grid;\n  grid-template-columns: 1fr 2fr 1fr;\n}\n\nbutton {\n  all: unset;\n  cursor: pointer;\n}\n\n#tabContainer {\n  display: flex;\n  justify-content: center;\n  gap: 1em;\n  margin-top: 5%;\n  grid-row: 1;\n  grid-column: 2;\n  border: 1px solid rgb(12, 12, 12);\n  margin-bottom: -.7em;\n  padding: 0.5em;\n  background-color: rgb(44, 71, 62);\n  color: azure;\n}\n\n\n#mainContainer {\n  display: flex;\n  justify-content: center;\n  margin-top: 1%;\n  border: 1px solid rgb(12, 12, 12);\n  grid-row: 2;\n  grid-column: 2;\n  padding-top: 2em;\n  padding-bottom: 2em;\n  background-color: rgb(209, 223, 223);\n  margin-bottom: 5em;\n\n}\n\n#toDoCreation, #createProjects, #toDoSection, #projectSection, #toDoWrap, #projectWrap {\n  display: none;\n}\n\n#toDoWrap {\n  min-width: inherit;\n  max-width: inherit;\n  width: 100%;\n}\n\n#toDoSection {\n  /*background-image: url(../src/img/notebook.svg);*/\n  /*background-image: url(../src/img/papertexture.jpg);*/\n  color: darkred;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));\n  grid-row: 1;\n  /*border: 1px red solid;*/\n  justify-items: center;\n  gap: 20px;\n}\n\n.ToDoListing {\n  width: 200px;\n  /*border: 1px red solid;*/\n  font-family: 'list-style' ;\n  font-size: 20px;\n}\n\n#projectWrap {\n  min-width: inherit;\n  max-width: inherit;\n  width: 100%;\n}\n\n#projectSection {\n  color: darkred;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));\n  grid-row: 1;\n  /*border: 1px red solid;*/\n  justify-items: center;\n  gap: 20px;\n}\n\n.projectLists {\n  width: 200px;\n  /*border: 1px red solid;*/\n  font-family: 'list-style' ;\n  font-size: 20px;\n}\n\n#footer {\n  display: flex;\n  align-content: center;\n  justify-content: center;\n  gap: 0.5em;\n  padding: 0.5em;\n  background-color: aliceblue;\n  grid-row: 4;\n  grid-column: 4;\n  /*border: 1px red solid;*/\n  position: fixed;\n  width: 100%;\n  bottom:0;\n  left:0;\n  right:0;\n  margin-top: 120px\n}\n\n#footertext {\n  margin-top: 0.5em;\n}"],"sourceRoot":""}]);
// Exports
