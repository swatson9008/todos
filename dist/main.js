...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/IndieFlower-Regular.ttf */ "./src/asset/IndieFlower-Regular.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/Lobster-Regular.ttf */ "./src/asset/Lobster-Regular.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/IBMPlexMono-Medium.ttf */ "./src/asset/IBMPlexMono-Medium.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/greentabpaper.jpeg */ "./src/asset/greentabpaper.jpeg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_4___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/orangetabpaper.jpg */ "./src/asset/orangetabpaper.jpg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_5___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/redtabpaper.jpg */ "./src/asset/redtabpaper.jpg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_6___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/yellowtabpaper.jpg */ "./src/asset/yellowtabpaper.jpg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_7___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/pinktabpaper.jpg */ "./src/asset/pinktabpaper.jpg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_8___ = new URL(/* asset import */ __webpack_require__(/*! ../src/asset/folderbg.jpg */ "./src/asset/folderbg.jpg"), __webpack_require__.b);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n@font-face {\n  font-family: 'list-style';\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n}\n\n@font-face {\n  font-family: 'tab-style';\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n}\n\n@font-face {\n  font-family: 'main-style';\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ");\n}\n\nbody {\n  background-color: lightsteelblue;\n  display: grid;\n  grid-template-columns: 1fr 2fr 1fr;\n}\n\nbutton {\n  all: unset;\n  cursor: pointer;\n}\n\ninput {\n  border-radius: 8px;\n}\n\n#tabContainer {\n  display: flex;\n  justify-content: center;\n  gap: 3em;\n  margin-top: 5%;\n  grid-row: 1;\n  grid-column: 2;\n  /*border: 1px solid rgb(12, 12, 12);*/\n  margin-bottom: -.7em;\n  padding: 0.5em;\n  /*background-color: rgb(44, 71, 62);*/\n  color: azure;\n}\n\n#homeTab {\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url(" + ___CSS_LOADER_URL_REPLACEMENT_3___ + ");\n  padding: 15px;\n  margin-bottom: -10px;\n  font-weight: bold;\n  box-shadow:  0px -10px 10px -10px black;\n}\n\n#taskAdd {\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url(" + ___CSS_LOADER_URL_REPLACEMENT_4___ + ");\n  padding: 15px;\n  margin-bottom: -10px;\n  font-weight: bold;\n  box-shadow:  0px -10px 10px -10px black;\n}\n\n#projectAdd {\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url(" + ___CSS_LOADER_URL_REPLACEMENT_5___ + ");\n  padding: 15px;\n  margin-bottom: -10px;\n  font-weight: bold;\n  box-shadow:  0px -10px 10px -10px black;\n}\n\n#taskList {\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url(" + ___CSS_LOADER_URL_REPLACEMENT_6___ + ");\n  padding: 15px;\n  margin-bottom: -10px;\n  font-weight: bold;\n  box-shadow:  0px -10px 10px -10px black;\n}\n\n#projectList {\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url(" + ___CSS_LOADER_URL_REPLACEMENT_7___ + ");\n  padding: 15px;\n  margin-bottom: -10px;\n  font-weight: bold;\n  box-shadow:  0px -10px 10px -10px black;\n}\n\n#homeTab:hover, #taskAdd:hover, #projectAdd:hover, #taskList:hover, #projectList:hover {\n  position: relative;\n  top: -5px;\n}\n\n#homeTab, #taskAdd, #projectAdd, #taskList, #projectList {\n  font-family: 'tab-style';\n}\n\n#mainContainer {\n  display: flex;\n  justify-content: center;\n  margin-top: 1%;\n  border-radius: 5px;\n  grid-row: 2;\n  grid-column: 2;\n  padding-top: 2em;\n  padding-bottom: 2em;\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url(" + ___CSS_LOADER_URL_REPLACEMENT_8___ + ");\n  margin-bottom: 5em;\n  box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;\n\n}\n\n#toDoCreation, #createProjects, #toDoSection, #projectSection, #toDoWrap, #projectWrap {\n  display: none;\n}\n\n#submitB, #submitP {\n  border: 2px black solid;\n  padding: 5px;\n  border-radius: 10px;\n  background-color: beige;\n}\n\n#toDoCover, #toDoCreation, #createProjects {\n  font-family: 'main-style';\n  font-size: 18px;\n}\n\n#toDoWrap {\n  min-width: inherit;\n  max-width: inherit;\n  width: 100%;\n}\n\n#toDoSection {\n  /*background-image: url(../src/img/notebook.svg);*/\n  /*background-image: url(../src/img/papertexture.jpg);*/\n  color: darkred;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));\n  grid-row: 1;\n  /*border: 1px red solid;*/\n  justify-items: center;\n  gap: 20px;\n}\n\n.ToDoListing {\n  width: 200px;\n  /*border: 1px red solid;*/\n  font-family: 'list-style' ;\n  font-size: 20px;\n}\n\n#toDoWrap select {\n  all: unset;\n  border: darkred 1px dotted;\n}\n\n#projectWrap {\n  min-width: inherit;\n  max-width: inherit;\n  width: 100%;\n}\n\n#projectSection {\n  color: darkred;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));\n  grid-row: 1;\n  /*border: 1px red solid;*/\n  justify-items: center;\n  gap: 20px;\n}\n\n.projectLists {\n  width: 200px;\n  /*border: 1px red solid;*/\n  font-family: 'list-style' ;\n  font-size: 20px;\n}\n\n#footer {\n  display: flex;\n  align-content: center;\n  justify-content: center;\n  gap: 0.5em;\n  padding: 0.5em;\n  background-color: aliceblue;\n  grid-row: 4;\n  grid-column: 4;\n  /*border: 1px red solid;*/\n  position: fixed;\n  width: 100%;\n  bottom:0;\n  left:0;\n  right:0;\n  margin-top: 120px\n}\n\n#footertext {\n  margin-top: 0.5em;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":";AACA;EACE,yBAAyB;EACzB,4CAAgD;AAClD;;AAEA;EACE,wBAAwB;EACxB,4CAA4C;AAC9C;;AAEA;EACE,yBAAyB;EACzB,4CAA+C;AACjD;;AAEA;EACE,gCAAgC;EAChC,aAAa;EACb,kCAAkC;AACpC;;AAEA;EACE,UAAU;EACV,eAAe;AACjB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,QAAQ;EACR,cAAc;EACd,WAAW;EACX,cAAc;EACd,qCAAqC;EACrC,oBAAoB;EACpB,cAAc;EACd,qCAAqC;EACrC,YAAY;AACd;;AAEA;EACE,oIAAmI;EACnI,aAAa;EACb,oBAAoB;EACpB,iBAAiB;EACjB,uCAAuC;AACzC;;AAEA;EACE,oIAAmI;EACnI,aAAa;EACb,oBAAoB;EACpB,iBAAiB;EACjB,uCAAuC;AACzC;;AAEA;EACE,oIAAgI;EAChI,aAAa;EACb,oBAAoB;EACpB,iBAAiB;EACjB,uCAAuC;AACzC;;AAEA;EACE,oIAAmI;EACnI,aAAa;EACb,oBAAoB;EACpB,iBAAiB;EACjB,uCAAuC;AACzC;;AAEA;EACE,oIAAiI;EACjI,aAAa;EACb,oBAAoB;EACpB,iBAAiB;EACjB,uCAAuC;AACzC;;AAEA;EACE,kBAAkB;EAClB,SAAS;AACX;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,cAAc;EACd,kBAAkB;EAClB,WAAW;EACX,cAAc;EACd,gBAAgB;EAChB,mBAAmB;EACnB,oIAA6H;EAC7H,kBAAkB;EAClB,iDAAiD;;AAEnD;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,uBAAuB;EACvB,YAAY;EACZ,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,yBAAyB;EACzB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,kDAAkD;EAClD,sDAAsD;EACtD,cAAc;EACd,aAAa;EACb,2DAA2D;EAC3D,WAAW;EACX,yBAAyB;EACzB,qBAAqB;EACrB,SAAS;AACX;;AAEA;EACE,YAAY;EACZ,yBAAyB;EACzB,0BAA0B;EAC1B,eAAe;AACjB;;AAEA;EACE,UAAU;EACV,0BAA0B;AAC5B;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,cAAc;EACd,aAAa;EACb,2DAA2D;EAC3D,WAAW;EACX,yBAAyB;EACzB,qBAAqB;EACrB,SAAS;AACX;;AAEA;EACE,YAAY;EACZ,yBAAyB;EACzB,0BAA0B;EAC1B,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,qBAAqB;EACrB,uBAAuB;EACvB,UAAU;EACV,cAAc;EACd,2BAA2B;EAC3B,WAAW;EACX,cAAc;EACd,yBAAyB;EACzB,eAAe;EACf,WAAW;EACX,QAAQ;EACR,MAAM;EACN,OAAO;EACP;AACF;;AAEA;EACE,iBAAiB;AACnB","sourcesContent":["\n@font-face {\n  font-family: 'list-style';\n  src: url('../src/asset/IndieFlower-Regular.ttf');\n}\n\n@font-face {\n  font-family: 'tab-style';\n  src: url('../src/asset/Lobster-Regular.ttf');\n}\n\n@font-face {\n  font-family: 'main-style';\n  src: url('../src/asset/IBMPlexMono-Medium.ttf');\n}\n\nbody {\n  background-color: lightsteelblue;\n  display: grid;\n  grid-template-columns: 1fr 2fr 1fr;\n}\n\nbutton {\n  all: unset;\n  cursor: pointer;\n}\n\ninput {\n  border-radius: 8px;\n}\n\n#tabContainer {\n  display: flex;\n  justify-content: center;\n  gap: 3em;\n  margin-top: 5%;\n  grid-row: 1;\n  grid-column: 2;\n  /*border: 1px solid rgb(12, 12, 12);*/\n  margin-bottom: -.7em;\n  padding: 0.5em;\n  /*background-color: rgb(44, 71, 62);*/\n  color: azure;\n}\n\n#homeTab {\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url('../src/asset/greentabpaper.jpeg');\n  padding: 15px;\n  margin-bottom: -10px;\n  font-weight: bold;\n  box-shadow:  0px -10px 10px -10px black;\n}\n\n#taskAdd {\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url('../src/asset/orangetabpaper.jpg');\n  padding: 15px;\n  margin-bottom: -10px;\n  font-weight: bold;\n  box-shadow:  0px -10px 10px -10px black;\n}\n\n#projectAdd {\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url('../src/asset/redtabpaper.jpg');\n  padding: 15px;\n  margin-bottom: -10px;\n  font-weight: bold;\n  box-shadow:  0px -10px 10px -10px black;\n}\n\n#taskList {\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url('../src/asset/yellowtabpaper.jpg');\n  padding: 15px;\n  margin-bottom: -10px;\n  font-weight: bold;\n  box-shadow:  0px -10px 10px -10px black;\n}\n\n#projectList {\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url('../src/asset/pinktabpaper.jpg');\n  padding: 15px;\n  margin-bottom: -10px;\n  font-weight: bold;\n  box-shadow:  0px -10px 10px -10px black;\n}\n\n#homeTab:hover, #taskAdd:hover, #projectAdd:hover, #taskList:hover, #projectList:hover {\n  position: relative;\n  top: -5px;\n}\n\n#homeTab, #taskAdd, #projectAdd, #taskList, #projectList {\n  font-family: 'tab-style';\n}\n\n#mainContainer {\n  display: flex;\n  justify-content: center;\n  margin-top: 1%;\n  border-radius: 5px;\n  grid-row: 2;\n  grid-column: 2;\n  padding-top: 2em;\n  padding-bottom: 2em;\n  background-image: linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url('../src/asset/folderbg.jpg');\n  margin-bottom: 5em;\n  box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;\n\n}\n\n#toDoCreation, #createProjects, #toDoSection, #projectSection, #toDoWrap, #projectWrap {\n  display: none;\n}\n\n#submitB, #submitP {\n  border: 2px black solid;\n  padding: 5px;\n  border-radius: 10px;\n  background-color: beige;\n}\n\n#toDoCover, #toDoCreation, #createProjects {\n  font-family: 'main-style';\n  font-size: 18px;\n}\n\n#toDoWrap {\n  min-width: inherit;\n  max-width: inherit;\n  width: 100%;\n}\n\n#toDoSection {\n  /*background-image: url(../src/img/notebook.svg);*/\n  /*background-image: url(../src/img/papertexture.jpg);*/\n  color: darkred;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));\n  grid-row: 1;\n  /*border: 1px red solid;*/\n  justify-items: center;\n  gap: 20px;\n}\n\n.ToDoListing {\n  width: 200px;\n  /*border: 1px red solid;*/\n  font-family: 'list-style' ;\n  font-size: 20px;\n}\n\n#toDoWrap select {\n  all: unset;\n  border: darkred 1px dotted;\n}\n\n#projectWrap {\n  min-width: inherit;\n  max-width: inherit;\n  width: 100%;\n}\n\n#projectSection {\n  color: darkred;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));\n  grid-row: 1;\n  /*border: 1px red solid;*/\n  justify-items: center;\n  gap: 20px;\n}\n\n.projectLists {\n  width: 200px;\n  /*border: 1px red solid;*/\n  font-family: 'list-style' ;\n  font-size: 20px;\n}\n\n#footer {\n  display: flex;\n  align-content: center;\n  justify-content: center;\n  gap: 0.5em;\n  padding: 0.5em;\n  background-color: aliceblue;\n  grid-row: 4;\n  grid-column: 4;\n  /*border: 1px red solid;*/\n  position: fixed;\n  width: 100%;\n  bottom:0;\n  left:0;\n  right:0;\n  margin-top: 120px\n}\n\n#footertext {\n  margin-top: 0.5em;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _asset_folderbg_jpg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./asset/folderbg.jpg */ "./src/asset/folderbg.jpg");
...
function displayHomeTab(e) {
  ...
  mainContainer.style.backgroundImage = `linear-gradient(0deg, rgba(158, 158, 158, 0.3), rgba(165, 165, 165, 0.3)), url(${_asset_folderbg_jpg__WEBPACK_IMPORTED_MODULE_1__})`;
}
...
/***/ "./src/asset/IBMPlexMono-Medium.ttf":
/*!******************************************!*\
  !*** ./src/asset/IBMPlexMono-Medium.ttf ***!
  \******************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "e44b6da17070f5fecd5b.ttf";
...
/***/ "./src/asset/folderbg.jpg":
/*!********************************!*\
  !*** ./src/asset/folderbg.jpg ***!
  \********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "fef15e394e1ae60290b4.jpg";

/***/ }),

/***/ "./src/asset/greentabpaper.jpeg":
/*!**************************************!*\
  !*** ./src/asset/greentabpaper.jpeg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "91632aa51b22be7e792d.jpeg";

/***/ }),

/***/ "./src/asset/orangetabpaper.jpg":
/*!**************************************!*\
  !*** ./src/asset/orangetabpaper.jpg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "aee9d8e06832a73fd0d7.jpg";
...
module.exports = __webpack_require__.p + "2fc07acffd64aea806b1.jpg";

/***/ }),

/***/ "./src/asset/pinktabpaper.jpg":
/*!************************************!*\
  !*** ./src/asset/pinktabpaper.jpg ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "41d0326efc1d82cabd3d.jpg";

/***/ }),

/***/ "./src/asset/redtabpaper.jpg":
/*!***********************************!*\
  !*** ./src/asset/redtabpaper.jpg ***!
  \***********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "d28a37157cf2d054b8b9.jpg";

/***/ }),

/***/ "./src/asset/yellowtabpaper.jpg":
/*!**************************************!*\
  !*** ./src/asset/yellowtabpaper.jpg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "eeadc92a92ca736d677b.jpg";
